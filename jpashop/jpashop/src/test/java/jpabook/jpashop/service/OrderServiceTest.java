...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("주문 가격은 가격 * 수량이다.", 10000 * orderCount,
    ...
    public void 주문취소() throws Exception {
        ...
        Long orderId = orderService.order(member.getId(), item.getId(),
                orderCount);
        //When
        orderService.cancelOrder(orderId); //10-2+2(복구) = 10
        //Then
        Order getOrder = orderRepository.findOne(orderId);
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        //When
        orderService.order(member.getId(), item.getId(), orderCount);//exception 터져야함 11>10
        //Then
